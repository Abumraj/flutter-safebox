import 'package:safebox/controller/copy_page_controller.dart';
import 'package:flutter/material.dart';
import 'package:safebox/core/app_export.dart';
import 'package:safebox/models/fileslist1_item_model.dart';
...
import 'package:safebox/widgets/fileslist1_item_widget.dart';

class CopyPageScreen extends GetWidget<CopyPageController> {
  const CopyPageScreen({Key? key}) : super(key: key);
        ...
        child: SizedBox(
            ...
            child: Obx(() => ListView.separated(
                ...
                itemCount: controller
                    .copyPageModelObj.value.fileslist1ItemList.value.length,
                itemBuilder: (context, index) {
                  Fileslist1ItemModel model = controller
                      .copyPageModelObj.value.fileslist1ItemList.value[index];
                  return Fileslist1ItemWidget(model);
                }))));
  }
