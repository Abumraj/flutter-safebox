import 'package:safebox/controller/added_folder_controller.dart';
...
class AddedFolderScreen extends GetWidget<AddedFolderController> {
  const AddedFolderScreen({Key? key})
      : super(
          key: key,
        );
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    CustomImageView(
                      imagePath: ImageConstant.imgCloseBlueGray20042x42,
                      height: 42.adaptSize,
                      width: 42.adaptSize,
                      margin: EdgeInsets.only(left: 14.h),
                    ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      CustomImageView(
                        imagePath: ImageConstant.imgEmojiBlueGray700,
                        height: 26.adaptSize,
                        width: 26.adaptSize,
                      ),
                      CustomImageView(
