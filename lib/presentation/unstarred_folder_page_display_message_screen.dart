...
import 'package:safebox/controller/unstarred_folder_page_display_message_controller.dart';
...
class UnstarredFolderPageDisplayMessageScreen
    extends GetWidget<UnstarredFolderPageDisplayMessageController> {
  const UnstarredFolderPageDisplayMessageScreen({Key? key})
      : super(
          key: key,
        );
                      ...
                      Opacity(
                        ...
                        child: Padding(
                          ...
                          child: CustomSearchView(
                            ...
                            borderDecoration:
                                SearchViewStyleHelper.outlineGrayTL5,
                            fillColor: appTheme.gray50.withOpacity(0.67),
                          ),
                        ),
                      ),
                          ...
                          children: [
                            Opacity(
                              ...
                              child: CustomIconButton(
                                ...
                                decoration: IconButtonStyleHelper.fillBlueTL32,
  ...
  /// Section Widget
  Widget _buildUnstarredButton() {
    return CustomElevatedButton(
      height: 50.v,
      width: 213.h,
      text: "lbl_unstarred".tr,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration:
                                    AppDecoration.outlineGray40001.copyWith(
                                  borderRadius:
            ...
            children: [
              ...
              Padding(
                ...
                child: _buildBxsContact(
                  ...
                  uploadContactsText: "lbl_upload_contacts".tr,
                ),
              ),
              SizedBox(height: 30.v),
              Padding(
  ...
  Widget _buildBxsContact({
    required String userImage,
    required String uploadContactsText,
  }) {
    return Row(
      children: [
        CustomImageView(
