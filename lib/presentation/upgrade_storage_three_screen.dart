...
import 'package:safebox/controller/upgrade_storage_three_controller.dart';
...
class UpgradeStorageThreeScreen
    extends GetWidget<UpgradeStorageThreeController> {
  const UpgradeStorageThreeScreen({Key? key}) : super(key: key);
        ...
        child: Obx(() => Column(children: [
              Padding(
                  ...
                  child: CustomRadioButton(
                      text: "lbl_50_gb_storage".tr,
                      value: controller
                          .upgradeStorageThreeModelObj.value.radioList.value[0],
              ...
              Padding(
                  ...
                  child: CustomRadioButton(
                      ...
                      value: controller
                          .upgradeStorageThreeModelObj.value.radioList.value[1],
                      groupValue: controller.radioGroup2.value,
                      onChange: (value) {
                        controller.radioGroup2.value = value;
                      }))
  ...
  Widget _buildSeventySeven() {
    return Container(
        ...
        decoration: AppDecoration.outlineBlue8001
            .copyWith(borderRadius: BorderRadiusStyle.roundedBorder5),
        child: Row(
            ...
            children: [
              ...
              Padding(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("lbl_first_bank_plc".tr,
                            style: CustomTextStyles.titleSmallBlue800SemiBold),
                        SizedBox(height: 8.v),
                        Text("lbl_679".tr,
                            style: CustomTextStyles.labelLargeSofiaProBlue800_1)
                      ])),
              Spacer(),
              CustomImageView(
                  imagePath: ImageConstant.imgArrowRightBlue800,
                  height: 30.v,
                  width: 34.h,
