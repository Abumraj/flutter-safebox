import 'package:safebox/controller/whatsapp_page_controller.dart';
...
class WhatsappPageScreen extends GetWidget<WhatsappPageController> {
  const WhatsappPageScreen({Key? key}) : super(key: key);
                    ...
                    child: Column(children: [
                      Padding(
                          ...
                          child: CustomSearchView(
                              ...
                              hintText: "msg_search_whatsapp".tr)),
                      SizedBox(height: 40.v),
                      Align(
                          alignment: Alignment.centerLeft,
                          child: Padding(
                              padding: EdgeInsets.only(left: 31.h),
                              child: Text("msg_mon_21_mar_2022".tr,
                                  style: theme.textTheme.bodyMedium))),
                      SizedBox(height: 15.v),
                      _buildFileRow(),
                      SizedBox(height: 568.v),
                      SizedBox(
                          height: 517.v,
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
        ...
        title: AppbarTitle(
            text: "lbl_whatsapp".tr, margin: EdgeInsets.only(left: 10.h)),
        actions: [
          AppbarTrailingImage(
  ...
  Widget _buildFileRow() {
    return Padding(
        ...
        child: Row(
            ...
            children: [
              CustomImageView(
                  imagePath: ImageConstant.imgFileGreenA400,
                  height: 30.adaptSize,
                  width: 30.adaptSize,
              ...
              Padding(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("msg_stickers_db_crypt12".tr,
